...
import typing
from . import types
__all__: list[str] = ['EventApplyRecord', 'FillRecord', 'InMemoryLogSink', 'NormalizedLobEvent', 'PaperTradingSimulatorCore', 'types']
...
class NormalizedLobEvent:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, tsExchange: int = 0, tsReceived: int = 0, side: types.Side = ..., updateType: types.UpdateType = ..., priceTicks: int = 0, quantityLots: int = 0, orderId: int = -1, traderId: int = -1, aggressorId: int = -2, updateSource: types.UpdateSource = ..., symbolId: str = '') -> None:
        ...
class PaperTradingSimulatorCore:
    ...
    def depth_at(self, arg0: types.Side, arg1: int) -> int | None:
        ...
    def init_from_l2_snapshot(self, sides: list[types.Side], prices: list[int], quantities: list[int]) -> None:
        ...
    def init_from_l3_snapshot(self, sides: list[types.Side], prices: list[int], quantities: list[int], orderIds: list[int], traderIds: list[int]) -> None:
        ...

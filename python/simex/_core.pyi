...
import typing
__all__: list[str] = ['ADD', 'BUY', 'DELETE', 'FillRecord', 'HISTORICAL', 'InMemoryLogSink', 'MATCH', 'NoAggressorNeededSentinel', 'NormalizedLobEvent', 'PaperTradingSimulatorCore', 'SELL', 'SET', 'STRATEGY', 'SUBTRACT', 'Side', 'UnknownAggressorIdSentinel', 'UnknownOrderIdSentinel', 'UnknownTraderIdSentinel', 'UpdateSource', 'UpdateType']
class FillRecord:
    @property
...
class PaperTradingSimulatorCore:
    ...
    def depth_at(self, arg0: Side, arg1: int) -> int | None:
        ...
    def init_from_l2_snapshot(self, sides: list[Side], prices: list[int], quantities: list[int]) -> None:
        ...
    def init_from_l3_snapshot(self, sides: list[Side], prices: list[int], quantities: list[int], orderIds: list[int], traderIds: list[int]) -> None:
        ...
